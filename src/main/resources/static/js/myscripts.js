...
function showSeekF(){
   ...
   textAlert = textAlert + "<td class='day_td22'>";
   textAlert = textAlert + "<input type=\"text\" id=\"FindSpisok\" name=\"FindSpisok\" value=\"\" maxlength=\"6\" style=\"width:60px;\">";
   textAlert = textAlert + "</td>";
   textAlert = textAlert + "</tr><tr>";
   textAlert = textAlert + "<tr>";
   textAlert = textAlert + "<td class='day_td3f'>Номер вагона</td>";
   textAlert = textAlert + "<td class='day_td22'>";
   textAlert = textAlert + "<input type=\"text\" id=\"FindVagon\" name=\"FindVagon\" value=\"\" maxlength=\"8\"  style=\"width:70px;\">";
   textAlert = textAlert + "</td>";
   textAlert = textAlert + "</tr><tr>";
   textAlert = textAlert + "<td colspan=\"2\" style=\"padding-top:20px;\">";
...
function showMoveToArh(){
   ...
   textAlert = textAlert + "<td class='day_td22'>";
   textAlert = textAlert + "<input type=\"text\" id=\"note\" name=\"note\" value=\"\" maxlength=\"50\"  style=\"width:150px;\">";
   textAlert = textAlert + "</td>";
   textAlert = textAlert + "</tr><tr>";
